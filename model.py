...
import random,shutil # Module to generate random numbers. # Module that offers high-level file operations.
from keras.models import Sequential
from keras.layers import Dropout,Conv2D,Flatten,Dense, MaxPooling2D, BatchNormalization
from keras.models import load_model

#caputuring images for training
def generator(dir, gen=image.ImageDataGenerator(rescale=1./255), shuffle=True,batch_size=1,target_size=(24,24),class_mode='categorical' ): #saves everything in our directory and return everything as a batch size
...
#64 convolution filters used each of size 3x3 incresing the no. of channels
